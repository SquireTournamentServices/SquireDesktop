...
trait FFIPlayerLookup {
    extern "C" fn pid_name(self, tid: TournamentId) -> *const c_char;
    extern "C" fn pid_game_name(self, tid: TournamentId) -> *const c_char;
    extern "C" fn pid_status(self, tid: TournamentId) -> PlayerStatus;
    extern "C" fn pid_rounds(self, tid: TournamentId) -> *const RoundId;
}

impl FFIPlayerLookup for PlayerId {
