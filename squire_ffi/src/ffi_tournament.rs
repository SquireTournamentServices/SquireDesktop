...
trait FFITournamentLookup {
    extern "C" fn tid_standings(self) -> *const PlayerScore<StandardScore>;
    extern "C" fn tid_players(self) -> *const PlayerId;
    extern "C" fn tid_rounds(self) -> *const RoundId;
    extern "C" fn tid_add_player(self, __name: *const c_char) -> PlayerId;
    extern "C" fn tid_drop_player(self, pid: PlayerId, aid: AdminId) -> bool;
    extern "C" fn tid_add_admin_local(
        self,
        __name: *const c_char,
        aid: AdminId,
        uid: SquireAccountId,
    ) -> bool;
    extern "C" fn tid_thaw(self, aid: AdminId) -> bool;
    extern "C" fn tid_freeze(self, aid: AdminId) -> bool;
    extern "C" fn tid_end(self, aid: AdminId) -> bool;
    extern "C" fn tid_cancel(self, aid: AdminId) -> bool;
    extern "C" fn tid_start(self, aid: AdminId) -> bool;
    extern "C" fn tid_update_settings(
        self,
    ...
    extern "C" fn tid_pair_round(self, aid: AdminId) -> *const RoundId;
    extern "C" fn tid_name(self) -> *const c_char;
    extern "C" fn tid_format(self) -> *const c_char;
    extern "C" fn tid_starting_table_number(self) -> i32;
    extern "C" fn tid_use_table_number(self) -> bool;
    extern "C" fn tid_game_size(self) -> i32;
    extern "C" fn tid_min_deck_count(self) -> i32;
    extern "C" fn tid_max_deck_count(self) -> i32;
    extern "C" fn tid_pairing_type(self) -> i32;
    extern "C" fn tid_round_length(self) -> i64;
    extern "C" fn tid_reg_open(self) -> bool;
    extern "C" fn tid_require_check_in(self) -> bool;
    extern "C" fn tid_require_deck_reg(self) -> bool;
    extern "C" fn tid_status(self) -> TournamentStatus;
    extern "C" fn tid_round_slips_html(self, __css: *const c_char) -> *const c_char;
    extern "C" fn close_tourn(self) -> bool;
    extern "C" fn save_tourn(self, __file: *const c_char) -> bool;
}

/// TournamentIds can be used to get data safely from
/// the Rust lib with these methods
impl FFITournamentLookup for TournamentId {
