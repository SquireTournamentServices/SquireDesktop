...
use crate::{copy_to_system_pointer, print_err, SQUIRE_RUNTIME};

trait FFIRoundLookup {
    extern "C" fn rid_match_number(self, tid: TournamentId) -> i64;
    extern "C" fn rid_table_number(self, tid: TournamentId) -> i64;
    extern "C" fn rid_status(self, tid: TournamentId) -> RoundStatus;
    extern "C" fn rid_time_left(self, tid: TournamentId) -> i64;
    extern "C" fn rid_duration(self, tid: TournamentId) -> i64;
    extern "C" fn rid_players(self, tid: TournamentId) -> *const PlayerId;
    extern "C" fn rid_confirmed_players(self, tid: TournamentId) -> *const PlayerId;
    extern "C" fn rid_confirm_player(self, tid: TournamentId, aid: AdminId, pid: PlayerId) -> bool;
    extern "C" fn rid_record_draws(self, tid: TournamentId, aid: AdminId, draws: u32) -> bool;
    extern "C" fn rid_draws(self, tid: TournamentId) -> i32;
    extern "C" fn rid_result_for(self, tid: TournamentId, pid: PlayerId) -> i32;
    extern "C" fn rid_kill(self, tid: TournamentId, aid: AdminId) -> bool;
    extern "C" fn rid_time_extend(self, tid: TournamentId, aid: AdminId, ext: u64) -> bool;
    extern "C" fn rid_record_result(
        self,
        tid: TournamentId,
        aid: AdminId,
        pid: PlayerId,
...
impl FFIRoundLookup for RoundId {
